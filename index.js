...
client.on('message', msg => {
    ...
    if(msg.content == "/help"){/*
      ...
      .setTimestamp()
        .setFooter('Made by LoudyTheChicken#2089
', 'https://media.istockphoto.com/photos/letter-a-3d-red-isolated-on-white-with-shadow-orthogonal-projection-picture-id688125274?k=6&m=688125274&s=612x612&w=0&h=296XCpIcGlHejCFB7rpCecq7xC3O0C1pgvnUl0Z8AKc=');
      ...
      msg.channel.send(helpEmbed);
       ...
       const embed = {
        ...
        "author": {
          "name": "Bot made by LoudyTheChicken#2089",
